    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommercialBuilding", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommercialBuilding_Buildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommercialBuilding_Reality_Id",
                        column: x => x.Id,
                        principalTable: "Reality",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Office_CommercialBuilding_Id",
                        column: x => x.Id,
                        principalTable: "CommercialBuilding",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Productions_CommercialBuilding_Id",
                        column: x => x.Id,
                        principalTable: "CommercialBuilding",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Warehouses_CommercialBuilding_Id",
                        column: x => x.Id,
                        principalTable: "CommercialBuilding",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommercialBuilding_BuildingId",
                table: "CommercialBuilding",
                column: "BuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_CommercialBuilding_Id",
                table: "CommercialBuilding",
                column: "Id",
                unique: true);
