...
namespace DomovoiBackend.Persistence.Migrations
{
    ...
    [Migration("20240320122713_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.CounterAgent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Deal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Addiction.RentConditions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Addiction.RentRules", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Sell.Addiction.SellFeatures", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.Types.LegalCounterAgent", b =>
                {
                    b.HasBaseType("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.CounterAgent");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.Types.PhysicalCounterAgent", b =>
                {
                    b.HasBaseType("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.CounterAgent");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Rent", b =>
                {
                    b.HasBaseType("DomovoiBackend.Domain.Entities.Announcements.Deals.Deal");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Sell.Sell", b =>
                {
                    b.HasBaseType("DomovoiBackend.Domain.Entities.Announcements.Deals.Deal");
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Realities.CommercialBuildings.CommercialBuilding", b =>
                {
                    ...
                    b.ToTable("CommercialBuildings", (string)null);
                });
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Announcement", b =>
                {
                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.CounterAgent", "CounterAgent")
                        .WithMany()
                        .HasForeignKey("CounterAgentId");

                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.Deals.Deal", "Deal")
                        .WithMany()
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.Types.LegalCounterAgent", b =>
                {
                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.CounterAgent", null)
                        .WithOne()
                        .HasForeignKey("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.Types.LegalCounterAgent", "Id")
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.Types.PhysicalCounterAgent", b =>
                {
                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.CounterAgent", null)
                        .WithOne()
                        .HasForeignKey("DomovoiBackend.Domain.Entities.Announcements.CounterAgents.Types.PhysicalCounterAgent", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Rent", b =>
                {
                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.Deals.Deal", null)
                        .WithOne()
                        .HasForeignKey("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Rent", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Addiction.RentConditions", "RentConditions")
                        .WithMany()
                        .HasForeignKey("RentConditionsId");

                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Rent.Addiction.RentRules", "RentRules")
                        .WithMany()
            ...
            modelBuilder.Entity("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Sell.Sell", b =>
                {
                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.Deals.Deal", null)
                        .WithOne()
                        .HasForeignKey("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Sell.Sell", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("DomovoiBackend.Domain.Entities.Announcements.Deals.Types.Sell.Addiction.SellFeatures", "SellFeatures")
                        .WithMany()
